...
import CublinoGame.ass2.AI.heuristics.EckeHeuristic;
...
public class MCTSEcke extends AIMain {
    public MCTSEcke(String s, GameTypes g, Player p) {
        super(s, g, p);
    }
